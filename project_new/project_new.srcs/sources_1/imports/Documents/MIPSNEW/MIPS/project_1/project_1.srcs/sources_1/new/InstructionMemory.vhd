...
architecture Behavioral of InstructionMemory is
    ...
    --=>"00010001111011000000000000000010", -- if(t4 == t7) PC=PC+4+BranchAddr (beq t7 t4 0x0002)
    --=>"00010101111011000000000000000001", -- if(t4 != t7) PC=PC+4+BranchAddr (bne t7 t4 0x0001)
