...
architecture Behavioral of InstructionMemory is
    ...
    --14=>"00010001111011000000000000000010", -- if(t4 == t7) PC=PC+4+BranchAddr (beq t7 t4 0x0002)
    --15=>"00010101111011000000000000000001", -- if(t4 != t7) PC=PC+4+BranchAddr (bne t7 t4 0x0001)
    
    
    --=>"00000001010011000000000000011010", -- Lo = t2 / t4 , Hi= t2%t4  (div t2 t4)
    --=>"00000000000000000110100000010010", -- t6 = Lo  (mflo t5) 
    --=>"00000000000000000111000000010000", -- t7 = Hi  (mfhi t6)
